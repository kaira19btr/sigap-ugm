...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navGroups: NavGroup[] = [
    {
      groupTitle: 'SIGAP SHIELD (Q1)',
      pillarBadge: 'Shock-Responsive',
      pillarBadgeColor: 'bg-rose-500/20 text-rose-300 border-rose-500/30',
      items: [
        {
          id: 'early_warning',
          moduleNumber: '01',
        ...
        },
        {
          ...
          stageName: 'Risk-Layered Funding',
          icon: Coins,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
        {
    ...
    {
      groupTitle: 'SIGAP CONVERGE (Q2)',
      pillarBadge: 'Konvergensi Layanan',
      pillarBadgeColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
      items: [
        {
          id: 'converge_vulnerability_map',
          moduleNumber: 'CV-1',
          label: 'Human Capital Vulnerability',
          stageName: 'Stunting, APM & Faskes',
          icon: HeartPulse,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
        {
          ...
          moduleNumber: 'CV-2',
          label: 'Supply-Side Equalization',
          stageName: 'Kesehatan & Pendidikan',
          icon: Building2,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
      ],
    ...
    {
      groupTitle: 'SIGAP RISE (Q3)',
      pillarBadge: 'Livelihood Graduation',
      pillarBadgeColor: 'bg-purple-500/20 text-purple-300 border-purple-500/30',
      items: [
        {
          id: 'rise_inclusion_tracker',
          moduleNumber: 'RS-1',
          label: 'Productive Inclusion Tracker',
          stageName: '5-Stage Cohort Pipeline',
          icon: TrendingUp,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
        {
          ...
          moduleNumber: 'RS-2',
          label: 'Graduation Scorecard',
          stageName: 'Validasi 4 Pilar Mandiri',
          icon: Award,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
      ],
    },
    {
      ...
      pillarBadge: 'Tata Kelola Lintas Pilar',
      pillarBadgeColor: 'bg-blue-500/20 text-blue-300 border-blue-500/30',
      items: [
        {
          id: 'monev',
          moduleNumber: '04',
          label: 'Monitoring & Evaluasi',
          stageName: 'Feedback Loop 360°',
          icon: BarChart3,
          allowedRoles: ['admin_pusat', 'admin_daerah'],
        },
        {
  ...
  return (
    ...
    >
        ...
        {navGroups.map((group, groupIdx) => (
          <div key={groupIdx} className="space-y-1">
            ...
            <div className="px-2 pt-1 pb-1.5 flex items-center justify-between">
              ...
              <span className={`text-[9px] font-mono font-bold px-1.5 py-0.5 rounded border ${group.pillarBadgeColor}`}>
                {group.pillarBadge}
              </span>
            </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-medium transition-all text-left group relative ${
                    isActive
                      ? 'bg-gradient-to-r from-rose-600 via-rose-500 to-blue-600 text-white shadow-md font-semibold border border-rose-400/30'
                      : isAllowed
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="truncate">
                      ...
                      {item.stageName && (
                        <div className={`text-[9px] font-mono font-medium tracking-wide ${isActive ? 'text-amber-200' : 'text-slate-500'}`}>
                          {item.stageName}
                        </div>
                      )}
                    </div>
      ...
      <div className="p-3 border-t border-rose-950/40 bg-black/30 backdrop-blur-xs space-y-2.5 relative z-10 shrink-0">
        {/* Role Selector */}
