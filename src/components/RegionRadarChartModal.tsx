...
export const RegionRadarChartModal: React.FC<RegionRadarChartModalProps> = ({
  ...
  const radarData = [
    {
      indicator: 'Intensitas Shock (BMKG)',
      fullName: '1. Intensitas Shock / Bencana Fisik',
    ...
    },
    {
      ...
      fullName: '2. Kerusakan Infrastruktur & Akses Jalan',
    ...
    },
    {
      ...
      fullName: '3. Proporsi Rumah Tangga Rentan (Desil 1-2)',
    ...
    },
    {
      ...
      fullName: '4. Rasio Beban Ketergantungan (Lansia/Anak/Disabilitas)',
    ...
    },
    {
      ...
      fullName: '5. Keterbatasan Fiskal & Logistik Daerah',
    ...
    },
    {
      ...
      fullName: '6. Gangguan Rantai Pasok Pangan Pokok',
    ...
    },
    {
      ...
      fullName: '7. Proyeksi Durasi Krisis & Risiko Susulan',
