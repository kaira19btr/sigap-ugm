...
export function GlobeLive({
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        markers: markers.map((m) => ({
          location: m.location,
          size: m.id === activeMarkerId ? 0.04 : 0.025,
          id: m.id,
        })),
        arcs: [],
  ...
  }, [markers, speed, initialPhi, initialTheta, dark, baseColor, markerColor, glowColor, activeMarkerId])
      ...
      {markers.map((m, i) => (
        <div
          ...
          style={{
            ...
            pointerEvents: onSelectMarker ? ("auto" as const) : ("none" as const),
            whiteSpace: "nowrap" as const,
            opacity: `var(--cobe-visible-${m.id}, 0)`,
            filter: `blur(calc((1 - var(--cobe-visible-${m.id}, 0)) * 8px))`,
            transition: "opacity 0.4s, filter 0.4s",
            cursor: onSelectMarker ? "pointer" : "default",
        ...
        >
          <span
            style={{
              width: 8,
              height: 8,
              background: m.status === 'siaga' ? '#f59e0b' : m.status === 'normal' ? '#10b981' : '#ff3b30',
              borderRadius: "50%",
              boxShadow: m.status === 'siaga' ? '0 0 8px #f59e0b' : m.status === 'normal' ? '0 0 8px #10b981' : '0 0 8px #ff3b30',
          ...
          <span
            style={{
              ...
              fontWeight: 600,
              letterSpacing: "0.1em",
              color: m.status === 'siaga' ? '#f59e0b' : m.status === 'normal' ? '#10b981' : '#ff3b30',
